...
export interface ProvidedContext {
  ...
  // The HA area this Chickadee device is assigned to (its own device's area in HA's registry), e.g.
...
export interface PromptContext {
  ...
  // open-core). Absent/null → 'Chickadee' (byte-identical legacy prompt).
