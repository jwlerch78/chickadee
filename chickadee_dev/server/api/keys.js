...
// PUT / used to require a Chickadee account, which was the feeds finding a third
...
// Chickadee account — which is exactly what the console promises on the Voice & AI
...
router.get('/', (req, res) => {
    ...
    // silently does nothing (a stored Claude key used to validate green and still bill Chickadee
