...
`;
    ...
    const INQUIRY_DASHIE_HELP = `# Inquiry Context: Chickadee Product Help
...
- dashie_help: query: {question: "the user's question"} - Detailed help on Chickadee ITSELF: settings and where to find them, how-to steps, troubleshooting ("how do I add a calendar", "where do I change the theme", "why is my screen black"). Do NOT use for who/what-are-you or general "about Chickadee" questions — answer those directly from your identity context. Never web_search Chickadee product questions`;
