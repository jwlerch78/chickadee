...
const VoiceAiApi = {
    ...
    AI_DEFAULT_KEYS: [
        ...
        ['voice', 'alwaysUseAI'],
        ['voice', 'searchSource'],
        // Which HA entities voice can control: 'dashboard' (entities on the Chickadee dashboard —
        ...
        ['voice', 'localSttUrl'],
        // Household Chickadee Intelligence sharing — ACCOUNT-scoped (2026-07-13). Was stored
