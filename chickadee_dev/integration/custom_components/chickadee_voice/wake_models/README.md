...
|---|---|---|
| `hey_dashie.tflite` / `.json` | "Hey Chickadee" | `hey_dashie` — the default | 
...
any build's default. See [PROVENANCE.md](https://github.com/jwlerch78/chickadee/blob/main/PROVENANCE.md).

## Provenance

Both models were **trained in-house by Chickadee** (see
...
[the add-on's DOCS.md](https://github.com/jwlerch78/chickadee/blob/main/chickadee-ha/DOCS.md#permissions--what-this-add-on-touches).
