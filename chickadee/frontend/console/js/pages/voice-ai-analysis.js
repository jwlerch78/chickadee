...
const VoiceAiAnalysis = {
    ...
    _interactions: [],
    _retain: false,
    // "Share to improve Chickadee" consent (user_settings.share_for_improvement column,
    ...
    /** "Share to improve Chickadee" (beta cohort). Enabling requires an explicit
    ...
    /** One conversation turn: You/Chickadee lines, with the AI response latency
     *  (end-of-user-speech → response) shown on "Chickadee said" when captured.
     ...
     *  Chickadee responses of a (possibly multi-turn) interaction. Falls back to the flat
