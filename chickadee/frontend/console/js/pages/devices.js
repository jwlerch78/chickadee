...
const DevicesPage = {
    ...
    /** Top-bar action buttons — Preview Chickadee + (in Details) Screenshot / Camera sub-toggles.
    ...
    topBarActions() {
        ...
        // '/' is Home Assistant, not the Chickadee dashboard.
    ...
    /** Look up the HA entity slug (e.g. 'fire_tv') for a Chickadee device_id from
