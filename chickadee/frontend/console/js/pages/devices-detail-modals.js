...
const DevicesDetailModals = {
    ...
    renderDisplayBody(device, display, sleep) {
        ...
        // Chickadee-for-HA box. What changes is the account-less case: `widgets`
    ...
    renderVoicePersonalityModal() {
        ...
        // device behaves as the app default (Chickadee).
    ...
    renderVoiceVoiceModal() {
        ...
        // default Chickadee voice (Inworld) per character — mark them explicitly.
    ...
    // Source type is device-specific; albums are listable only for the Chickadee
    ...
    // Chickadee album is chosen — the keys applyDeviceSettings fans out to
    ...
    _photoSourceOptions(device) {
        ...
        // The edition filter drops `supabase` (Chickadee albums — family
