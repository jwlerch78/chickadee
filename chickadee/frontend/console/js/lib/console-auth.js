/* ============================================================
   Chickadee — Auth (self-contained, no module imports)
...
const DashieAuth = {
    ...
    _configs: {
        production: { url: '', anonKey: '', googleClientId: '' },
        development: { url: '', anonKey: '', googleClientId: '' },
    },
     ...
     * ingress panel; running without a Chickadee account is a normal operating
    ...
    //  When served by Chickadee (Node/Express HA add-on), the SPA takes its
        ...
        try {
            ...
            if (resp.ok) {
                ...
                if (data?.addon === true) {
                    ...
                    console.log('[DashieAuth] Running inside Chickadee', data);
                    return true;
                }
            }
    ...
    signIn() {
        ...
        const params = new URLSearchParams({
            ...
            access_type: 'offline',
            // 'select_account' → after signing out of Chickadee, the Google account
