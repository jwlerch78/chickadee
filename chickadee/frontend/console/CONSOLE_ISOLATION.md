...
CLOSED FAMILY DELTA  (calendar, chores, family, rewards, locations,
        ...
        ├── Chickadee add-on (full)  → HA users with a Chickadee account
        └── web console                   → consumer families
```

Until 2026-07-30 this boundary was cut on a **brand** axis (Chickadee vs
Chickadee). It is the same boundary; it is now named for what it actually is — an
...
- **I5 — Config for user-owned engines never persists to Chickadee cloud.**
