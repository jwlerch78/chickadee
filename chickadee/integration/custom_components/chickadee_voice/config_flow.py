...
"""Config + options flows for Chickadee Voice.
...
class ChickadeeVoiceConfigFlow(ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_hassio(
        ...
        payload and asks the user to confirm adding Chickadee Voice.
        """
        bridge = {
    ...
    @staticmethod
    @callback
    def async_get_options_flow(config_entry: ConfigEntry) -> ChickadeeVoiceOptionsFlow:
        return ChickadeeVoiceOptionsFlow()


class ChickadeeVoiceOptionsFlow(OptionsFlow):
