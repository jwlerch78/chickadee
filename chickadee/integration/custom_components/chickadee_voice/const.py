...
"""Constants for the Chickadee Voice integration."""

DOMAIN = "chickadee_voice"
...
# (chickadee -> chickadee_voice) and the sibling kept testing the dead name, so it
# never ceded and we DROP'd forever. Cross-brand pairs never collide: each brand
# serves its own route prefix.
DEVICE_SIBLING_DOMAIN = "chickadee"
...
# integration, NOT by other add-ons. (Pattern inherited from the Chickadee bridge
