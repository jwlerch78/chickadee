...
//
// Every route here proxies to the Chickadee Voice integration's feed_registry using
// the add-on's OWN HA credential (haClient.getConfig()). Not one of them reads or
// writes a Chickadee account: household camera feeds belong to the HA user.
//
// Gating them on a Chickadee sign-in made Video Feeds unusable for exactly the user
// this edition is for — someone running HA who never made a Chickadee account. The
...
/** Fetch a Chickadee-integration HTTP view path and relay status + JSON body. */
